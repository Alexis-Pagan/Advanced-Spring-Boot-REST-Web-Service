package signup.service.swagger;
...
public class Swagger {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2) 
				.select().apis(RequestHandlerSelectors.basePackage("signup.service.controllers"))
	...
	private ApiInfo info() {
		return new ApiInfoBuilder()
				.title("REST API")
				.version("5.0")
				.description("Web REST Service Documentation Portal")
				.build();
	}
