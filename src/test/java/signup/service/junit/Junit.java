...
import signup.service.controllers.EmailController;
import signup.service.error.handling.GlobalExceptionHandler;
...
public class Junit {
	...
	/*
	 * testing cross-cutting concerns for exception handling
	 */
	@Test
	public void testControllerAdviceHttpBadUrl() throws Exception {
				
		MockHttpServletResponse response = mockMvc
				.perform(get("/users/emails-addresses/email")
				.accept(MediaType.APPLICATION_JSON_VALUE)
				.contentType(MediaType.APPLICATION_JSON_VALUE))
